...
/**
 * The <code>StringResource</code> class represents a Pascal string resource.
 * @since KSFL 1.0
 * @author Rebecca G. Bettencourt, Kreative Software
 */
public class StringResource extends MacResource {
	/**
	 * The resource type of a Pascal string resource,
	 * the four-character constant <code>STR </code>.
	 */
	public static final int RESOURCE_TYPE = KSFLConstants.STR;
	/**
	 * The resource type of a Mac OS MultiFinder string resource,
	 * the four-character constant <code>mstr</code>.
	 */
	public static final int RESOURCE_TYPE_MULTIFINDER_STRING = KSFLConstants.mstr;
	 ...
	 */
	public StringResource(short id, byte[] data) {
	 ...
	 * @param data The resource data.
	 */
	public StringResource(short id, String name, byte[] data) {
	 ...
	 * @param data The resource data.
	 */
	public StringResource(short id, byte attr, byte[] data) {
	 ...
	 * @param data The resource data.
	 */
	public StringResource(short id, byte attr, String name, byte[] data) {
	 ...
	 * @param data The resource data.
	 */
	public StringResource(int type, short id, byte[] data) {
		super(type, id, data);
	}
	 ...
	 * @param data The resource data.
	 */
	public StringResource(int type, short id, String name, byte[] data) {
	 ...
	 * @param data The resource data.
	 */
	public StringResource(int type, short id, byte attr, byte[] data) {
	 ...
	 * @param data The resource data.
	 */
	public StringResource(int type, short id, byte attr, String name, byte[] data) {
	...
	public String getString() {
		return new String(data, 1, data[0] & 0xFF);
	}
	...
	public String getString(String tenc) throws UnsupportedEncodingException {
		return new String(data, 1, data[0] & 0xFF, tenc);
	}
}
