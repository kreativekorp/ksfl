...
/**
 * The <code>MacResourceAlreadyExistsException</code> should be thrown by
 * any class extending <code>MacResourceProvider</code> when an attempt is
 ...
 * @author Rebecca G. Bettencourt, Kreative Software
 */
public class MacResourceAlreadyExistsException extends IOException {
	static final long serialVersionUID = 1;
	
	/**
	 * Constructs a <code>MacResourceAlreadyExistsException</code> with
	 * <code>null</code> as its error detail message.
	 */
	public MacResourceAlreadyExistsException() {
		super();
	}
	 ...
	 */
	public MacResourceAlreadyExistsException(String s) {
		super(s);
	}
}
